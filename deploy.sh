fission spec init
fission env create --spec --name onb-us-enum-exp-env --image nexus.sigame.com.br/fission-onboarding-us-enum-exp:0.2.0-0 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
